...
export default function DomeGallery({
  ...
  const items = useMemo(() => {
    ...
    return buildItems(shuffledImages, segments);
  }, [shuffledImages, images, segments]);
  ...
  useEffect(() => {
    ...
    const handleWheel = (e: WheelEvent) => {
      ...
      const nextX = clamp(
        rotationRef.current.x - e.deltaY * sensitivity,
        -maxVerticalRotationDeg,
        maxVerticalRotationDeg
      );
      const nextY = wrapAngleSigned(rotationRef.current.y + e.deltaX * sensitivity);
  ...
  useEffect(() => {
    ...
    autoRotateRAF = requestAnimationFrame(step);
    return () => cancelAnimationFrame(autoRotateRAF);
  }, []);
